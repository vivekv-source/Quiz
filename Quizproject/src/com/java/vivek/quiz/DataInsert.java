	...
	public void insertStudentData() {
		try {
			...
			ps = con.prepareStatement(
					"insert into qa(q_id,q_name,q_ans_a,q_ans_b,q_ans_c,q_ans_d,cor_ans)values(?,?,?,?,?,?,?)");
//			ps.setInt(1, 1);
...
//			ps.setString(6, "None");
//			ps.setString(7, "java.lang.Object");
//
//			//--------------------------------------------------------------------------------------------------------------			
//			ps.setInt(1, 7);
...
//			ps.setString(7, "Java Virtual Machine");
//
//			//--------------------------------------------------------------------------------------------------------------			
			ps.setInt(1, 10);
